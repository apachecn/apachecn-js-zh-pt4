...
![Image](img/square.jpg) **注意**除了维护应用程序状态之外，我不打算讨论 HTML5 API。我在*的 HTML5* 权威指南中提供了全部细节，该指南也由 Apress 出版。你可以在`[http://dev.w3.org/html5/spec](http://dev.w3.org/html5/spec)`阅读 W3C 规范(关于历史 API 的信息在 5.4 节，但这可能会改变，因为 HTML5 规范仍在草案中)。
