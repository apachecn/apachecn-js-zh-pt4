...
我在本章中实现的一些契约为其他应用提供服务，我需要一个助手应用来演示这些功能。这个应用叫做`FileHelper`，它非常简单，使用我在第 23 章的[中介绍的文件拾取器来加载和保存一个图像文件。您可以在](23.html#ch23)[清单 24-7](#list_24_7) 中看到`FileHelper`项目的`default.html`文件的内容。
