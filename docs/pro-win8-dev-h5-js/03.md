...
![images](images/square.jpg) **提示**在[第五章](05.html)我解释了*为什么*default . CSS 和 default.js 文件的内容总是可用，当我解释 Windows 应用如何处理导入的 HTML 内容时。
