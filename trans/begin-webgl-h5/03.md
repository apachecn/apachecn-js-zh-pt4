...
![9781430239963_Fig03-01.jpg](images/9781430239963_Fig03-01.jpg)
...
![9781430239963_Fig03-02.jpg](images/9781430239963_Fig03-02.jpg)
...
![image](images/sq.jpg) **注意**我们将图像存储在 textureImage 变量中，而不是保存 WebGLTexture 对象的 texture 变量中。
...
![image](images/sq.jpg) **注意**这只是加载图像数据的一种方式。您也可以在现有的< img >标签中使用该图像:

![](./textures/smiley-128px.jpg)
