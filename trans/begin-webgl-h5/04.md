...
![9781430239963_Fig04-01.jpg](images/9781430239963_Fig04-01.jpg)
...
![image](images/sq.jpg) **注**更多 gl-matrix.js 的使用示例可以在[https://github.com/toji/gl-matrix/blob/master/README.md](https://github.com/toji/gl-matrix/blob/master/README.md)在线找到
...
![image](images/sq.jpg) **注意**本章中的代码并没有针对性能进行优化。因为我们只有几个网格，这无关紧要。然而，对于涉及许多绘制调用的更复杂的场景，我们将需要编写优化的代码。请参考[第 9 章](09.html)了解最佳实践和提高性能的方法。
...
![image](images/sq.jpg) **注**单位球面上每一点的法线值就是该点本身(缩放或平移前)。记住法向量是垂直指向表面的方向，从原点开始，这个方向就是向量本身。球坐标是单位长度的，所以这个向量已经被归一化了。
...
![9781430239963_Fig04-02.jpg](images/9781430239963_Fig04-02.jpg)
...
![9781430239963_Fig04-03.jpg](images/9781430239963_Fig04-03.jpg)
...
![9781430239963_Fig04-04.jpg](images/9781430239963_Fig04-04.jpg)
...
![9781430239963_Fig04-05.jpg](images/9781430239963_Fig04-05.jpg)
...
![9781430239963_Fig04-06.jpg](images/9781430239963_Fig04-06.jpg)
